<?php
class Insertar_dinamico extends ControladorPrincipal{
    //private $modelo;
    ...
    public function get(){
        ...
        <thead class="thead-dark">
            <tr>
             ...
             <tr>
                <td><input class="text-center" id="fecha" name='fecha' type='date' style="width:196px" required/></td>
                <td><input class="text-center" id="peso" name='peso' type='number' style="width:121px" required/></td>
                <td><input class="text-center" id="tipo" name='tipo' type='text' style="width:146px" required/></td>
    ...
    public function submit(){
        if(isset($_POST["fecha"], $_POST["peso"], $_POST["tipo"])){
            ...
            $this->modelo->insertar($fecha, $peso, $tipo, $utilidad, $produccion, $descripcion);
        }
    }    
}
?>