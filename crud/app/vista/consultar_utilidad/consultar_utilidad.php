...
?>
<script src="<?php echo RUTA_URL; ?>/scripts/consultar_utilidad.js"></script>
</head>
<body>
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#insertar" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Insertar</a>
                ...
                <li class="active">
                    <a href="#consultar" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">Consultar</a>
                    <ul class="collapse list-unstyled show" id="consultar">
                        <li class="active">
                            <a href="#animal" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">Animal</a>
                            <ul class="collapse list-unstyled show" id="animal">
                                <li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="borrar">
                        <li>
