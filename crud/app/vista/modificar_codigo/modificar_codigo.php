...
?>
<script src="<?php echo RUTA_URL; ?>/scripts/modificar_codigo.js"></script>
</head>
<body>
    <div class="d-flex align-items-stretch">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    <a href="#modificar" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">Modificar</a>
                    <ul class="collapse list-unstyled show" id="modificar">
                        <li class="active">
